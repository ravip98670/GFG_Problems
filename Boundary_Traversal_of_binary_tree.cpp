...
public:
    void rightNodeTraversal(Node *root, vector<int> &ans){
        ...
        else rightNodeTraversal(root->left,ans);
    ...
    void boundaryTraversal(Node *root, vector<int> &ans){
        ...
        boundaryTraversal(root->left,ans);
        boundaryTraversal(root->right,ans);
    }
    void leftNodeTraversal(Node *root, vector<int> &ans){
        ...
        if(root->left)
            leftNodeTraversal(root->left,ans);
        else leftNodeTraversal(root->right,ans);
